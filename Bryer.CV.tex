...
\section{Education}
\cventry{2006-present\\ Expected 2012}{Doctoral Candidate}{University at Albany}{Albany, NY}{}{Educational Psychology \& Methodology}  % arguments 3 to 6 can be left empty
...
Conduct research and data analysis related to the college's mission. This includes developing, administering, and analyzing surveys; analyzing data from the college's student information system; and consulting with individual schools to develop specific measures.}
...
\nociteunpublished{naepchapter,multilevelPSAJSS}
...
%Software
\nocitesoftware{makeR,multilevelPSA,irutils,ruca,ipeds,qualtrics,irutils,FractalJ}
